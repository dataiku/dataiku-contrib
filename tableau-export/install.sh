...
case "$distrib" in
	osx)
		curl "http://downloads.tableau.com/tssoftware/Tableau-SDK-Python-OSX-64Bit-9-2-4.tar.gz" |tar --strip-components 1 -x -f -
		;;
	*)
		curl "http://downloads.tableau.com/tssoftware/Tableau-SDK-Python-Linux-64Bit-9-2-4.tar.gz" |tar --strip-components 1 -x -f -
		;;
esac

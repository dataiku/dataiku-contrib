...
function prettyStringify(json, extraFormatting = null, spacing = 4) {
    ...
    const results1 = results.split('\"###[###').join('[');   // string.replace is sidelined: does not replace all occurrences
    const results2 = results1.split('###]###\"').join(']');  // string.replace is sidelined: does not replace all occurrences
    const results3 = results2.split('###\\"###').join('\"'); // string.replace is sidelined: does not replace all occurrences
    const results4 = results3.split('###,###').join(',');    // string.replace is sidelined: does not replace all occurrences
    return results4;
}